...
# This file is provided to you as a starting point for the "fruit_quiz.py" program of the Project
# of Programming Principles in Summer School, 2025.  It aims to give you just enough code to help ensure
